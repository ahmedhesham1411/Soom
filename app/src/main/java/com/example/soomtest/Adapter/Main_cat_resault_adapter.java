...
public class Main_cat_resault_adapter extends RecyclerView.Adapter<Main_cat_resault_adapter.ViewHolder> {
    ...
    public Main_cat_resault_adapter(List<MainCategoryModel> mainCategoryModels, Context context,OnClickHander onClickHander) {
